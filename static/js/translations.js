...
const translations = {
    en: {
        ...
        "toast_email_rate_limit": "Email rate limit exceeded. Please wait 15 seconds.",
        ...
        "comment_placeholder": "Add a comment... (15s cooldown)",
        "reply_placeholder": "Write a reply... (15s cooldown)",
        ...
        "forgot_password_subtitle": "Enter your email. If an account exists, we will send a password reset link",
    ...
    ru: {
        ...
        "toast_email_rate_limit": "Лимит отправки писем превышен. Пожалуйста, подождите 15 секунд.",
        ...
        "comment_placeholder": "Написать комментарий... (задержка 15 сек)",
        "reply_placeholder": "Написать ответ... (задержка 15 сек)",
        ...
        "forgot_password_subtitle": "Введите email. Если аккаунт существует, мы отправим ссылку для восстановления пароля",
